      ...
      {stats && (
        <div className="grid grid-cols-3 gap-3 mb-6">
          <div className="bg-default-100 rounded-xl p-4 text-center">
            ...
            <p className="text-sm text-default-500 mt-1">Bars</p>
          </div>
          <div className="bg-default-100 rounded-xl p-4 text-center">
            <p className="text-3xl font-bold">{stats.totalSessions}</p>
            <p className="text-sm text-default-500 mt-1">Sessions</p>
          </div>
          <div className="bg-default-100 rounded-xl p-4 text-center">
            <p className="text-3xl font-bold">{stats.totalDrinks}</p>
            <p className="text-sm text-default-500 mt-1">Drinks</p>
          </div>
        </div>
      )}
